...
public class Exo3_SummaryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View myView = inflater.inflate(R.layout.fragment_tp_exo3_summary, container, false);
        CommonHelper.createReturnBtn(this,(ConstraintLayout) myView.findViewById(R.id.tp3_exo3_summary));
