...
public class Exo4_SummaryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View myView = inflater.inflate(R.layout.fragment_tp_exo4_summary, container, false);
        CommonHelper.createReturnBtn(this,(ConstraintLayout) myView.findViewById(R.id.tp3_exo4_summary));
